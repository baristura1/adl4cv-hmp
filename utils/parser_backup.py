...
parser.add_argument('--lr',type=int,default=8e-03,help= 'Learning rate of the optimizer')
...
parser.add_argument('--clip_grad',type=float,default=1000,help= 'select max norm to clip gradients')
